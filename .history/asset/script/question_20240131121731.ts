...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    const questionListContainer = document.getElementBy
...
// Append headTitle to questionListContainer
if (headTitle) {
  questionListContainer.appendChild(headTitle);
}

// Append headImg to questionListContainer
if (headImg) {
  questionListContainer.appendChild(headImg);
}
