    ...
    function displayCurrentQuestion() {
        ...
        nextButton.addEventListener('click', () => {
            ...
            if (currentQuestionIndex < totalQuestions) {
                ...
                // Calculate and show total score on the next page
                showTotalScore();
            }
        });
...
function markOption(optionElement: HTMLElement, isCorrect: boolean) {
    // Set the border color for the current option
    if (isCorrect) {
    ...
    Array.from(optionsList.children).forEach((optionElement) => {
        if (optionElement instanceof HTMLElement) {
            ...
            if (option === correctAnswer) {
                ...
                markOption(optionElement, false);
            }
        }
    });
}
...
function onNextButtonClick() {
    ...
    if (currentQuestionIndex < totalQuestions) {
        // Clear the marking from the previous question
        clearMarking();
...
// Function to clear marking from options
function clearMarking() {
    // Clear the border and marked class from all options
...
// Assuming you have a button element for "Next"
const nextButton = document.querySelector('.right-container button:last-child') as HTMLButtonElement | null;
